...
export function GallerySection({ title, description, screenshots, mobile = false }: { title: string; description: string; screenshots: ScreenshotRecord[]; mobile?: boolean }) {
  ...
  return (
    <section className="mb-10">
      ...
      <div className={mobile ? "grid grid-cols-2 items-start gap-3 md:grid-cols-3 xl:grid-cols-6" : "grid grid-cols-2 items-start gap-3 sm:grid-cols-2 lg:grid-cols-3"}>
